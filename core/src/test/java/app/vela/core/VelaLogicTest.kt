...
class SearchParserHoursTest {
    ...
    fun stripsBusinessNamePrefixFromAddress() {
        assertEquals("1451 W Covell Blvd, Davis, CA 95616",
            SearchParser.stripNamePrefix("Safeway, 1451 W Covell Blvd, Davis, CA 95616", "Safeway"))
        assertEquals("1451 W Covell Blvd",
            SearchParser.stripNamePrefix("Safeway 1451 W Covell Blvd", "Safeway"))
        ...
        // street merely named after the place would be beheaded ("Plaza, …" / "Access Rd, the metro").
        assertEquals(
            "Safeway Plaza, 1451 W Covell Blvd",
            SearchParser.stripNamePrefix("Safeway Plaza, 1451 W Covell Blvd", "Safeway"),
        )
        assertEquals("Boeing Access Rd, the metro", SearchParser.stripNamePrefix("Boeing Access Rd, the metro", "Boeing"))
